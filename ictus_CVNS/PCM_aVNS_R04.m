Experiments(rodent).ID= "aVNS_PCM_R04";

% % Experiment number 1 in rodent R04
    %%------ Flor fill in ------%%
    Experiment_number = 1;
...
% Experiment number 2 in rodent R04
    %%------ Flor fill in ------%%
    Experiment_number = 2;
    ...
    min_dur_sec = 5;                   % maximo: 20s
    PPM_window_sec = 5;


    experiment_fill_in;

% Experiment number 3 in rodent R04
    %%------ Flor fill in ------%%
    Experiment_number = 3;
    day_of_experiment = '18-06-2026'; %Day-month-year
    file = "R01_03";
