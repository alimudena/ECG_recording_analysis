Experiments(rodent).ID= "aVNS_PCM_R07";
   
% Experiment number 1 in rodent R07
    %%------ Flor fill in ------%%
    Experiment_number = 1;
    day_of_experiment = '08-07-2026'; %Day-month-year
    folder = "../../raw_data/PCM/matlab_archivos/aVNS_stroke_2";
    file = "R07_01";

    Experimental_type = "VNS_02";
...
% Experiment number 2 in rodent R07
    %------ Flor fill in ------%%
    Experiment_number = 2;
    day_of_experiment = '09-07-2026'; %Day-month-year
    file = "R07_02";
...
% Experiment number 3 in rodent R07
%     %------ Flor fill in ------%%
%     Experiment_number = 3;
%     day_of_experiment = '10-07-2026'; %Day-month-year
%     file = "R07_03";
% 
%     Experimental_type = "Dead";
% 
%     stim_time =  "30 seconds";
%     rest_time =  "5 minutes";
%     freq_stim =  "20 Hz";
