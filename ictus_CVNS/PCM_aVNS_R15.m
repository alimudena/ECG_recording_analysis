Experiments(rodent).ID= "aVNS_PCM_R15";

% Experiment number 1 in rodent R015
    %%------ Flor fill in ------%%
    Experiment_number = 1;
    day_of_experiment = '29-07-2026'; %Day-month-year
    ...
    min_dur_sec = 10;                   % mÃ­nimo: 20s
    PPM_window_sec = 5;


    experiment_fill_in;

% Experiment number 2 in rodent R015
    %%------ Flor fill in ------%%
    Experiment_number = 2;
    day_of_experiment = '30-06-2026'; %Day-month-year
    file = "R015_02";
...
% Experiment number 3 in rodent R015
    %%------ Flor fill in ------%%
    Experiment_number = 3;
    day_of_experiment = '31-07-2026'; %Day-month-year
    file = "R015_03";
