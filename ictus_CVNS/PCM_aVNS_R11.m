Experiments(rodent).ID= "aVNS_PCM_R11";

% % Experiment number 1 in rodent R011
    %%------ Flor fill in ------%%
    Experiment_number = 1;
...
% Experiment number 2 in rodent R011
    %%------ Flor fill in ------%%
    Experiment_number = 2;
...
% Experiment number 3 in rodent R011
    %%------ Flor fill in ------%%
    Experiment_number = 3;
