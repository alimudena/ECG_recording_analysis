Experiments(rodent).ID= "aVNS_PCM_R16";

% Experiment number 1 in rodent R016
    %%------ Flor fill in ------%%
    Experiment_number = 1;
    day_of_experiment = '27-07-2026'; %Day-month-year
    ...
    experiment_fill_in;
% Experiment number 2 in rodent R016
    %%------ Flor fill in ------%%
    Experiment_number = 2;
...
% Experiment number 3 in rodent R016
    %%------ Flor fill in ------%%
    Experiment_number = 3;
