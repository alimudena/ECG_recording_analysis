Experiments(rodent).ID= "aVNS_PCM_R14";

% Experiment number 1 in rodent R014
    %%------ Flor fill in ------%%
    Experiment_number = 1;
...
% Experiment number 2 in rodent R014
    %%------ Flor fill in ------%%
    Experiment_number = 2;
    day_of_experiment = '16-06-2026'; %Day-month-year
    file = "R014_02";
...
% Experiment number 3 in rodent R014
    %%------ Flor fill in ------%%
    Experiment_number = 3;
    day_of_experiment = '17-07-2026'; %Day-month-year
    file = "R014_03";
