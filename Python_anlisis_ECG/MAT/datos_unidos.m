...
if EXP == 2
    ...
    time_1                       = time;
    R_locs_1                     = R_extract(ECG_1, 0.4, fs);
    ...
    time_2                       = time;
    R_locs_2                     = R_extract(ECG_2, 0.6, fs);
...
elseif EXP == 3
    ...
    time_1                       = time;
    R_locs_1                     = R_extract(ECG_1, 0.6, fs);
    [BPM_1, interval_1]          = BMP_calculation(R_locs_1, Ts);
    fprintf(leg_1+"\r\n")
    if PLOT_ECGS == 1
        plot_ECG(time_1, ECG_1, R_locs_1, leg_1)
    ...
    time_5                    = time;
    R_locs_5                  = R_extract(ECG_5, 0.6, fs);
...
elseif EXP == 4
    ...
    time_6                    = time;
    R_locs_6                  = R_extract(ECG_6, 0.4, fs);
